...
export interface Asset { id:string; name:string; type:'COURSE'|'MEMBERSHIP'|'STORED_VALUE'|'ITEM'; purchase_price:number; total_units:number|null; used_units:number; current_balance:number|null; expiry_date:string|null; usage_count:number; last_used_at:string|null; }
